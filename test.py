...
# TODO REMOVE
# self-defined hyperparameters to make running it locally not unbearable
small_layer = 512
big_layer = 1024
...
param_grid = {
    ...
    "sampling_variance": [0.1, 0.3, 0.5], 
    "clip_value": [0.15], #[0.15, 0.2], 
    "actor_lr": [1e-4, 3e-4],
    "critic_lr": [1e-3, 3e-3],
